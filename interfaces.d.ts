declare namespace blog.timelineConnector {
    //https://github.com/microsoft/PowerApps-Samples/blob/master/model-driven-apps/custom-connectors/SecondaryRecordSource/solution/Interfaces.d.ts
    interface IRecordSource {
        init: (context: IConnectorContext, config?: JSON) => Promise<void>;
    ...
    interface IRecordField {
        components: any[]; //Mscrm.Component[];
    }
    ...
    interface IRecordUX {
        ...
        bubbleIcon?: any; //Mscrm.Component;
        header: IRecordField;
        headerIcon?: any; //Mscrm.Component;
        body: IRecordField;
        footer: IRecordField;
